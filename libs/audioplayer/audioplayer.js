		...
		this.each( function()
		{
			...
			if( isSupport )
			{
				...
				var theBar			  = thePlayer.find( '.' + cssClass.bar ),
					...
					barHandler        = thePlayer.find( '.' + cssClass.barHandler ),
				...
				theAudio.addEventListener( 'loadeddata', function()
				{
					...
					volumeAdjuster.find( '.volumeLine' ).width( theAudio.volume * 100 + '%' );
					volumeAdjuster.find( '.volumeHandler' ).css("left", theAudio.volume * 100 + '%' );
				...
				theAudio.addEventListener( 'timeupdate', function()
				{
					...
					barHandler.css("left", ( ( theAudio.currentTime / theAudio.duration ) * 100 + '%' ) );
				});
